...
Public Class Sign_Tester
    ...
    Private Sub Do_Start()
        ...
        If cmbSignType.Text = "ISLUS" Then
            ...
            Set_Frame_Image(10, Image.FromFile("images\10.bmp"))
            Set_Frame_Image(20, Image.FromFile("images\20.bmp"))
            Set_Frame_Image(30, Image.FromFile("images\30.bmp"))
            Set_Frame_Image(40, Image.FromFile("images\40.bmp"))
            Set_Frame_Image(50, Image.FromFile("images\50.bmp"))
            Set_Frame_Image(60, Image.FromFile("images\60.bmp"))
            Set_Frame_Image(70, Image.FromFile("images\70.bmp"))
            Set_Frame_Image(80, Image.FromFile("images\80.bmp"))
            Set_Frame_Image(182, Image.FromFile("images\UL.bmp"))
            Set_Frame_Image(183, Image.FromFile("images\UR.bmp"))
            Set_Frame_Image(184, Image.FromFile("images\LL.bmp"))
            Set_Frame_Image(185, Image.FromFile("images\LR.bmp"))
            Set_Frame_Image(189, Image.FromFile("images\X.bmp"))
            Set_Frame_Image(250, Image.FromFile("images\matrixTest.bmp"))
        End If
